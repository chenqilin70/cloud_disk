							...
							<td valign="top" class="tabContentTd">
								...
								<!-- 会话面板 -->
									<div class="tab-pane fade active in" id="session">
										<ul class="sessionUl">
											<c:forEach items="${dialogueList }" var="dialogue">
									...
									<div class="btnsInTip" align="right">
										...
										<div class="btn-group" role="group">
											...
											<ul class="dropdown-menu">
												<li><a href="#" class="deleteFriendLink" relationshipid="">删除好友</a></li>
	...
	<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        确认要删除好友<span class="deleteFriendNickname"></span>吗
	      </div>
	      <div class="modal-footer">
	        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
	        <button type="button" class="custombtn affirmDelete" relationshipid="">确定</button>
	      </div>
	    </div>
	  </div>
	</div>
