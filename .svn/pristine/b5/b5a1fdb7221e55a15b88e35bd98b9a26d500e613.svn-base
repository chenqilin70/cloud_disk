...
public class FileController {
	...
	public String surecopyto(@RequestParam(value="fileid") int fileid,HttpSession session) {
			...
			//说明复制的是一个子文件
		{
			...
			boolean copyto=filedao.surecopysonfileto(copy,fileid);
			session.removeAttribute("copefileid");
			return "blankblock";
		}
		else
		{
			...
			int fatherid=copy.getFileId();
			boolean copyto=filedao.surecopyfatherfileto(copy, fileid);
			return "blankblock";
		}
	}
